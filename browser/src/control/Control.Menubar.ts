	...
	options: {
		...
		presentation: [
			...
			{name: _UNO('.uno:FormatMenu', 'presentation'), id: 'format', type: 'menu', accessibility: {combination: 'MO'}, menu: [
				...
				{type: 'separator'},
				{uno: '.uno:TransformDialog'},
				{name: _UNO('.uno:ObjectAlign'), type: 'menu', menu: [
					{uno: '.uno:ObjectAlignLeft'},
					{uno: '.uno:AlignCenter'},
					{uno: '.uno:ObjectAlignRight'},
					{type: 'separator'},
					{uno: '.uno:AlignUp'},
					{uno: '.uno:AlignMiddle'},
					{uno: '.uno:AlignDown'}]},
				{name: _('Distribute'), type: 'menu', menu: [
					{uno: '.uno:DistributeHorzLeft'},
					{uno: '.uno:DistributeHorzCenter'},
					{uno: '.uno:DistributeHorzDistance'},
					{uno: '.uno:DistributeHorzRight'},
					{type: 'separator'},
					{uno: '.uno:DistributeVertTop'},
					{uno: '.uno:DistributeVertCenter'},
					{uno: '.uno:DistributeVertDistance'},
					{uno: '.uno:DistributeVertBottom'}]},
				{uno: '.uno:FormatLine'},
				{uno: '.uno:FormatArea'},
				{uno: '.uno:NameGroup'},
				{uno: '.uno:ObjectTitleDescription'},
