...
app.CSections.TableRangeHandle = 	{ name: 'table range handle'	, zIndex: 6 };
...
app.CSections.TableRangeHandle.processingOrder =		65; // Calc.
...
app.CSections.TableRangeHandle.drawingOrder =		94; // Calc.
